...
?>
		...
		<div id="content">
			...
			<div class="inner-content">
				...
				<!-- End slider -->
                  <div class="content-sections" style="min-height:100px !important; margin-bottom:1em;">
                  		<?php print wpautop($post->post_content) ?>
                  </div>
               <?php  if(@$_GET['pf']){ ?>
               
                <!-- // T2 Script -->
<script src="http://cmc-td.com/button/productfinder.php?urlid=23215"></script>
			 <?php
				} else {
			?>
				<!-- Tekservestudio script -->
				<script src="https://cmc-td.com/button/productfinder.php?urlid=23382"></script>
				<?php
				}
					  ?>
				<!-- Content sections 
